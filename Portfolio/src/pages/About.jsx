  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
        ...
        >
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
            <span className="w-8 h-px bg-purple-600 dark:bg-purple-500 mr-4"></span>
            Education
          </h2>
          <div className="glass-panel p-8 border-l-4 border-l-blue-600 dark:border-l-blue-500">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">B.Tech Computer Engineering</h3>
            <h4 className="text-blue-600 dark:text-blue-400 font-medium mb-4">Pimpri Chinchwad College of Engineering (PCCOE)</h4>
            <div className="flex items-center text-gray-600 dark:text-gray-400 text-sm">
              <span className="bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-full border border-gray-200 dark:border-gray-700">2024 – 2028</span>
            </div>
          </div>
        </motion.div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Object.entries(skills).map(([category, skillList], index) => (
            <div key={category} className="glass-panel p-6">
              <h3 className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-4 pb-2 border-b border-gray-200 dark:border-gray-800">{category}</h3>
              <div className="flex flex-wrap gap-2">
                {skillList.map(skill => (
                  <span key={skill} className="px-3 py-1.5 bg-gray-100 dark:bg-gray-800/50 text-gray-700 dark:text-gray-300 text-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    {skill}
                  </span>
                ))}
              </div>
