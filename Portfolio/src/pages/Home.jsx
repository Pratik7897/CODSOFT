  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] flex flex-col justify-center overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-2xl md:text-4xl font-semibold mb-6 h-12 flex items-center">
              <span className="text-gray-700 dark:text-gray-200 mr-2">I am a</span>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/projects" className="px-8 py-3 bg-white dark:bg-card hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white font-medium rounded-xl transition-all shadow-sm">
                View Projects
              </Link>
              <Link to="/contact" className="px-8 py-3 bg-transparent border border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-400 text-gray-700 dark:text-white font-medium rounded-xl transition-all">
                Contact Me
              </Link>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-[300px] h-[300px] md:w-[450px] md:h-[450px]">
              ...
              <div className="absolute inset-0 rounded-full overflow-hidden border-4 border-white dark:border-gray-800/50 shadow-2xl z-10 flex items-center justify-center bg-gray-100 dark:bg-gray-900">
                <img 
                  src={profileImg} 
                  alt="Pratik Shinde" 
              ...
              <motion.div 
                ...
                className="absolute top-10 -right-4 md:right-4 w-12 h-12 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center border border-gray-200 dark:border-gray-700 z-20 shadow-xl"
              >
              ...
              <motion.div 
                ...
                className="absolute bottom-20 -left-6 w-14 h-14 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center border border-gray-200 dark:border-gray-700 z-20 shadow-xl"
              >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
        <span className="text-xs text-gray-500 dark:text-gray-500 mb-2">Scroll to explore</span>
        <motion.div 
          animate={{ y: [0, 8, 0] }}
          transition={{ repeat: Infinity, duration: 1.5 }}
          className="w-5 h-8 border-2 border-gray-400 dark:border-gray-600 rounded-full flex justify-center pt-1"
        >
          <div className="w-1 h-2 bg-gray-400 dark:bg-gray-400 rounded-full"></div>
        </motion.div>
      </div>
    </div>
  );
